    ...
    <div class="cookies__alert">
        <div class="cookies__container">
            <div class="cookies__wrapper">
                <p class="cookies__title fs-2">@lang('cookieConsent::cookies.title')</p>
                            ...
                            <div class="cookies__expandable" id="cookies-policy-{{ $category->key() }}">
                                <ul class="cookies__definitions">
                                    @foreach ($category->getCookies() as $cookie)
                                        @if ($category->key() === 'optional')
                                            @if ($cookie->name === 'password_remember')
                                        ...
                                        @else
                                            <li class="cookies__cookie">
                                                ...
                                                @if ($cookie->description)
                                                    <p class="cookies__description">@lang('cookieConsent::cookies.defaults.' . $cookie->name)</p>
                                                @endif
                                            </li>
                                        @endif
                                    @endforeach
