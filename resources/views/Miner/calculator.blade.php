                    ...
                    <div class="card-body">
                        <div id="inputsRock">
                            ...
                            <div class="d-flex flex-row-reverse me-2 mt-4 mb-1">
                                <button type="button" class="btn btn-outline-success" id="btnAddPartRock">@lang('calculator.view.input.additionalShare')</button>
                            </div>
                        </div>
                        <div id="inputsShip" hidden>
                            ...
                            <div class="d-flex flex-row-reverse me-2 mt-4 mb-1">
                                <button type="button" class="btn btn-outline-success" id="btnAddPartShip">@lang('calculator.view.input.additionalShare')</button>
                            </div>
                        </div>
                    </div>
                </div>
