    ...
    <div class="jobEdit-box card" id="yourJob">
        ...
        ?>
            <div class="box-text card-body mt-2">
                ...
                <div class="container mt-3">
                    <div class="progress">
                    <div class="progress-bar progress-bar-animated progress-bar-striped" role="progressbar" aria-valuemin="0" aria-valuemax="100" style="width:       
                        <?php
                            echo getMAXTimeOfJobPercent($JobPosInArray)
                        ?>%">
                        <?php
                            echo getMAXTimeOfJobPercent($JobPosInArray) . "%";
                        ?>
