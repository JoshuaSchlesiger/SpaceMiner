...
return [
    ...
    'defaults' => [
        'spaceminer_cookie_consent' => 'Used to store the user\'s cookie consent preferences.',
        'spaceminer_session' => 'Used to identify the user\'s browsing session.',
        'XSRF-TOKEN' => 'Used to secure both the user and our website against cross-site request forgery attacks.',
