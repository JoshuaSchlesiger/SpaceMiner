...
<body>
    ...
    <div class="container">
        <div class="mt-4">
            ...
            <p><strong>Allgemeine Hinweise zum Widerruf und Widerspruch (Opt-Out):&nbsp;</strong>Nutzer k&ouml;nnen die von ihnen abgegebenen Einwilligungen jederzeit widerrufen und zudem einen Widerspruch gegen die Verarbeitung entsprechend den gesetzlichen Vorgaben im Art. 21 DSGVO einlegen. Nutzer k&ouml;nnen ihren Widerspruch auch &uuml;ber die Einstellungen ihres Browsers erkl&auml;ren, z.B. durch Deaktivierung der Verwendung von Cookies (wobei dadurch auch die Funktionalit&auml;t unserer Online-Dienste eingeschr&auml;nkt sein kann).
            ...
            <ul type="disc">
                ...
                <li><strong>Content-Delivery-Network:&nbsp;</strong>Wir setzen ein &quot;Content-Delivery-Network&quot; (CDN) ein. Ein CDN ist ein Dienst, mit dessen Hilfe Inhalte eines Onlineangebotes, insbesondere gro&szlig;e Mediendateien, wie Grafiken oder Programm-Skripte, mit Hilfe regional verteilter und &uuml;ber das Internet verbundener Server schneller und sicherer ausgeliefert werden k&ouml;nnen; <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).</li>
                <li><strong>1&amp;1 IONOS:&nbsp;</strong>Leistungen auf dem Gebiet der Bereitstellung von informationstechnischer Infrastruktur und verbundenen Dienstleistungen (z.B. Speicherplatz und/oder Rechenkapazit&auml;ten); <strong>Dienstanbieter:</strong> 1&amp;1 IONOS SE, Elgendorfer Str. 57, 56410 Montabaur, Deutschland; <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); <strong>Website:</strong> <a href="https://www.ionos.de" target="_blank">https://www.ionos.de</a>; <strong>Datenschutzerkl&auml;rung:</strong> <a href="https://www.ionos.de/terms-gtc/terms-privacy" target="_blank">https://www.ionos.de/terms-gtc/terms-privacy</a>; <strong>Auftragsverarbeitungsvertrag:</strong> <a href="https://www.ionos.de/hilfe/datenschutz/allgemeine-informationen-zur-datenschutz-grundverordnung-dsgvo/auftragsverarbeitung/" target="_blank">https://www.ionos.de/hilfe/datenschutz/allgemeine-informationen-zur-datenschutz-grundverordnung-dsgvo/auftragsverarbeitung/</a>.</li>
            </ul>
            <p><strong>Registrierung, Anmeldung und Nutzerkonto</strong></p>
            <p>Nutzer k&ouml;nnen ein Nutzerkonto anlegen. Im Rahmen der Registrierung werden den Nutzern die erforderlichen Pflichtangaben mitgeteilt und zu Zwecken der Bereitstellung des Nutzerkontos auf Grundlage vertraglicher Pflichterf&uuml;llung verarbeitet. Zu den verarbeiteten Daten geh&ouml;ren insbesondere die Login-Informationen (Nutzername und Passwort).</p>
            ...
            <ul type="disc">
                <li><strong>Verarbeitete Datenarten:</strong> Bestandsdaten (z.B. Namen, Adressen); Kontaktdaten (z.B. E-Mail, Telefonnummern); Inhaltsdaten (z.B. Eingaben in Onlineformularen); Meta-, Kommunikations- und Verfahrensdaten (z. B. IP-Adressen, Zeitangaben, Identifikationsnummern, Einwilligungsstatus).</li>
                <li><strong>Betroffene Personen:</strong> Nutzer (z.B. Webseitenbesucher, Nutzer von Onlinediensten).</li>
                <li><strong>Zwecke der Verarbeitung:</strong> Erbringung vertraglicher Leistungen und Kundenservice; Sicherheitsma&szlig;nahmen; Verwaltung und Beantwortung von Anfragen; Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit.</li>
            ...
            <p><strong>Weitere Hinweise zu Verarbeitungsprozessen, Verfahren und Diensten:</strong></p>
            <ul type="disc">
                <li><strong>Registrierung mit Pseudonymen:&nbsp;</strong>Nutzer d&uuml;rfen statt Klarnamen Pseudonyme als Nutzernamen verwenden; <strong>Rechtsgrundlagen:</strong> Vertragserf&uuml;llung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO).</li>
                <li><strong>L&ouml;schung von Daten nach K&uuml;ndigung:&nbsp;</strong>Wenn Nutzer ihr Nutzerkonto gek&uuml;ndigt haben, werden deren Daten im Hinblick auf das Nutzerkonto, vorbehaltlich einer gesetzlichen Erlaubnis, Pflicht oder Einwilligung der Nutzer, gel&ouml;scht; <strong>Rechtsgrundlagen:</strong> Vertragserf&uuml;llung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b) DSGVO).</li>
            </ul>
            <p><strong>Kontakt- und Anfragenverwaltung</strong></p>
            ...
            <p><a href="https://datenschutz-generator.de/" target="_blank" title="Rechtstext von Dr. Schwenke - für weitere Informationen bitte anklicken.">Erstellt mit kostenlosem Datenschutz-Generator.de von Dr. Thomas Schwenke</a></p>
            <p>&nbsp;</p>
