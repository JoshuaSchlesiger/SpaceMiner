...
if (isset($_POST["sentRegister"])) {
    ...
    if ($username_statusCheck == "" && $password_status == "" && $checkbox_status == "" && $username_statusUsed == "") {
        ...
        if ($time_diff > 2) {
            ...
            $_SESSION["jobs"] = serialize($data);
            $_SESSION["crews"] = serialize($data);
            $_SESSION["players"] = serialize($data);
            $_SESSION["tasks"] = serialize($data);
            ...
            <div class="LoReformContainer LoRewindow">
                ...
                <form action="" method="post">
                    <div>
                        ...
                        <input type="text" class="LOREinput form-control rounded-pill " name="username" placeholder="Username" value="<?php if (isset($_POST["username"])) {
                                                                                                                                            echo htmlspecialchars($_POST["username"]);
                                                                                                                                        } ?>">
                    </div>
                    <div class="text-danger fst-italic ms-2"><?php echo $username_statusCheck;
                                                                echo $username_statusUsed ?></div>
                    <div class="mt-3">
